<?php
/**
 * The part of the Notícias page that changes: featured card, filter, grid and
 * pagination.
 *
...
<?php else : ?>
	 ...
	 * card above it is the only post in the category being filtered: the label
	 * and the filter are printed either way, and a heading over nothing reads
